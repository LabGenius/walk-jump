...
class AbDataModule(LightningDataModule):
    ...
    prepare_data_per_node: bool = False # added due to errorbeing thrown
    _log_hyperparams: bool = False # added due to errorbeing thrown
    allow_zero_length_dataloader_with_multiple_devices: bool = False # added due to errorbeing thrown
